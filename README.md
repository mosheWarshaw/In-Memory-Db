...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;It accepts an array of ```Col```s in which you can define all the thigns you would want to be able to do in a regular SQL select, such as renaming a column, and using the values of other cells in the row to determine the value, to mention a couple.
